...
set_property PACKAGE_PIN P1  [get_ports {addr_memIN[4]}]
set_property PACKAGE_PIN D19 [get_ports {addr_memIN[3]}]
set_property PACKAGE_PIN G18 [get_ports {addr_memIN[2]}]
set_property PACKAGE_PIN F18 [get_ports {addr_memIN[1]}]
set_property PACKAGE_PIN E18 [get_ports {addr_memIN[0]}]
