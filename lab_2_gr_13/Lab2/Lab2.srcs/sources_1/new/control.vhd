...
begin
    ...
    process(clk) is
    begin
        if rising_edge(clk) then -- Synchronous since dependent of clock.
            if rst = '1' then
                -- reset values
                sign_done <= '0';
                ...
                mem_out_we <= '0';
                sel_load <= "00";
                en_alu_reg1, en_alu_reg2, en_mult_reg1, en_mult_reg2, en_yti, en_ytr <= '0';
                ...
                case curr_state is
                    ...
                    when state_op_1 =>
                        ...
                        mem_out_we <= '0';
                        sel_load <= "00";
                        en_alu_reg1, en_alu_reg2, en_yti, en_ytr <= '0';
                        en_mult_reg1, en_mult_reg2 <= '1';
                        oper <= "010";
                        sw_out <= 'X';
                        mem_out_we <= '0';
                    ...
                    when state_op_2 =>
                        ...
                        mem_out_we <= '0';  
                        sel_load <= "00";
                        en_alu_reg2, en_yti, en_ytr <= '0';
                        en alu_reg1, en_mult_reg1, en_mult_reg2 <= '1';
                        oper <= "011";
                        sw_out <= 'X';
                        mem_out_we <= '0';
                    ...
                    when state_op_3 =>
                        ...
                        mem_out_we <= '0';
                        sel_load <= "00";
                        en_mult_reg1, en_mult_reg2, en_yti, en_ytr <= '0';
                        en_alu_reg1, en_alu_reg2 <= '1';
                        oper <= "100";
                        sw_out <= 'X';
                        mem_out_we <= '0';
                    ...
                    when state_op_4 =>
                        ...
                        mem_out_we <= '0';
                        sel_load <= "00";
                        en_mult_reg1, en_mult_reg2, en_yti, en_ytr, en_alu_reg1 <= '0';
                        en_alu_reg2 <= '1';  
                        oper <= "101";
                        sw_out <= 'X';
                        mem_out_we <= '0';
                    ...
                    when state_op_5 =>
                        ...
                        mem_out_we <= '0';
                        sel_load <= "00";
                        en_alu_reg1, en_alu_reg2, en_mult_reg1, en_mult_reg2 <= '0';
                        en_yti, en_ytr <= '1';
                        oper <= "110";
                        sw_out <= 'X';
                        mem_out_we <= '0';
